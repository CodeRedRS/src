package codered.crPestDeprecated;
...
public class crPest extends PollingScript<ClientContext> implements PaintListener, MessageListener {
    ...
    public void start() {
        ...
        crVariables.antiCameraAngle = true;
        crVariables.antiRandomTab = true;
        crVariables.antiMouseMovement = true;
    ...
    public void repaint(Graphics g) {
        ...
        PestPaint pestPaint = new PestPaint(ctx);
